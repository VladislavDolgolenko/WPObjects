...
class Lessc {
	...
	protected function newFormatter() {
		$className = "\WPObjects\LessCompiler\LesscFormatterlessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "\WPObjects\LessCompiler\LesscFormatter$this->formatterName";
		}
...
class LesscParser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('\WPObjects\LessCompiler\Lessc', 'preg_quote'),
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("\WPObjects\LessCompiler\Lessc", "preg_quote"), $directives));
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("\WPObjects\LessCompiler\Lessc", "preg_quote"), $stop);
